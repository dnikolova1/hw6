...
// Key: 565907b044d0978437c3b4b0b5625b6d
...
window.addEventListener('DOMContentLoaded', async function(event) {
    ...
    let url = `https://api.themoviedb.org/3/movie/now_playing?api_key=565907b044d0978437c3b4b0b5625b6d&language=en-US`
    ...
    for (let i=0; i<movies.results.length; i++) {
        ...
        <div class="movie-${movie.id} w-1/5 p-4 ${MovieName}">
